...
init_param_groups(void)
{
	...
	param_group[j].param_list[k++] = PARAM_FILTER1_CUTOFF;
	param_group[j].param_list[k++] = PARAM_FILTER1_RESONANCE;
	param_group[j].param_list[k++] = PARAM_FILTER1_SMOOTHING;
	param_group[j].param_list[k++] = PARAM_FILTER1_KEYFOLLOW;
	param_group[j].param_list[k++] = PARAM_FILTER1_MODE;
	param_group[j].param_list[k++] = PARAM_FILTER1_TYPE;
	param_group[j].param_list[k++] = PARAM_FILTER1_LFO;
	param_group[j].param_list[k++] = PARAM_FILTER1_LFO_CUTOFF;
	param_group[j].param_list[k++] = PARAM_FILTER1_LFO_RESONANCE;
	param_group[j].param_list[k++] = PARAM_FILTER1_GAIN;
	param_group[j].param_list[k++] = -1;
	j++;
	k = 0;
	notebook_order[3] = j;
	...
	param_group[j].notebook_x    = 1;
	param_group[j].wide_x        = 4;
	param_group[j].param_list[k++] = PARAM_FILTER1_ENV_SIGN;
	param_group[j].param_list[k++] = PARAM_FILTER1_ENV_AMOUNT;
	param_group[j].param_list[k++] = PARAM_FILTER1_ATTACK;
	param_group[j].param_list[k++] = PARAM_FILTER1_DECAY;
	param_group[j].param_list[k++] = PARAM_FILTER1_SUSTAIN;
	param_group[j].param_list[k++] = PARAM_FILTER1_RELEASE;
	param_group[j].param_list[k++] = -1;
	j++;
	k = 0;
	notebook_order[7] = j;
	...
	param_group[j].name = "Reverb";
	param_group[j].label = "<b>Reverb</b>";
	param_group[j].full_x  = 1;
	param_group[j].notebook_page = 0;
	param_group[j].notebook_x    = 2;
	param_group[j].wide_x        = 1;
	param_group[j].param_list[k++] = PARAM_REVERB_MIX;
	param_group[j].param_list[k++] = PARAM_REVERB_WIDTH;
	param_group[j].param_list[k++] = PARAM_REVERB_DEPTH;
	param_group[j].param_list[k++] = PARAM_REVERB_DAMPING;
	param_group[j].param_list[k++] = -1;
	j++;
	k = 0;
	notebook_order[12] = j;
	...
	notebook_order[20] = j;
	one_page_order[20] = j;
	widescreen_order[20] = j;
	param_group[j].name = "voice1";
	param_group[j].label = "<b>Voice-1</b>";
	param_group[j].full_x  = 2;
	param_group[j].notebook_page = 2;
	param_group[j].notebook_x    = 0;
	param_group[j].wide_x        = 5;
	param_group[j].param_list[k++] = PARAM_VOICE1_MUTE;
	param_group[j].param_list[k++] = PARAM_VOICE1_PAN;
	param_group[j].param_list[k++] = PARAM_VOICE1_OSC_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE1_CUTOFF_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE1_ATTACK_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE1_DECAY_TUNE;
	param_group[j].param_list[k++] = -1;
	j++;
	k = 0;
	notebook_order[21] = j;
	one_page_order[21] = j;
	widescreen_order[21] = j;
	param_group[j].name = "voice2";
	param_group[j].label = "<b>Voice-2</b>";
	param_group[j].full_x  = 2;
	param_group[j].notebook_page = 2;
	param_group[j].notebook_x    = 1;
	param_group[j].wide_x        = 5;
	param_group[j].param_list[k++] = PARAM_VOICE2_MUTE;
	param_group[j].param_list[k++] = PARAM_VOICE2_PAN;
	param_group[j].param_list[k++] = PARAM_VOICE2_OSC_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE2_CUTOFF_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE2_ATTACK_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE2_DECAY_TUNE;
	param_group[j].param_list[k++] = -1;
	j++;
	k = 0;
	notebook_order[22] = j;
	one_page_order[22] = j;
	widescreen_order[22] = j;
	param_group[j].name = "voice3";
	param_group[j].label = "<b>Voice-3</b>";
	param_group[j].full_x  = 2;
	param_group[j].notebook_page = 2;
	param_group[j].notebook_x    = 2;
	param_group[j].wide_x        = 5;
	param_group[j].param_list[k++] = PARAM_VOICE3_MUTE;
	param_group[j].param_list[k++] = PARAM_VOICE3_PAN;
	param_group[j].param_list[k++] = PARAM_VOICE3_OSC_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE3_CUTOFF_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE3_ATTACK_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE3_DECAY_TUNE;
	param_group[j].param_list[k++] = -1;
	j++;
	k = 0;
	notebook_order[23] = j;
	one_page_order[23] = j;
	widescreen_order[23] = j;
	param_group[j].name = "voice4";
	param_group[j].label = "<b>Voice-4</b>";
	param_group[j].full_x  = 2;
	param_group[j].notebook_page = 2;
	param_group[j].notebook_x    = 3;
	param_group[j].wide_x        = 5;
	param_group[j].param_list[k++] = PARAM_VOICE4_MUTE;
	param_group[j].param_list[k++] = PARAM_VOICE4_PAN;
	param_group[j].param_list[k++] = PARAM_VOICE4_OSC_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE4_CUTOFF_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE4_ATTACK_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE4_DECAY_TUNE;
	param_group[j].param_list[k++] = -1;
	j++;
	k = 0;
	notebook_order[24] = j;
	one_page_order[24] = j;
	widescreen_order[24] = j;
	param_group[j].name = "voice5";
	param_group[j].label = "<b>Voice-5</b>";
	param_group[j].full_x  = 2;
	param_group[j].notebook_page = 2;
	param_group[j].notebook_x    = 0;
	param_group[j].wide_x        = 5;
	param_group[j].param_list[k++] = PARAM_VOICE5_MUTE;
	param_group[j].param_list[k++] = PARAM_VOICE5_PAN;
	param_group[j].param_list[k++] = PARAM_VOICE5_OSC_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE5_CUTOFF_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE5_ATTACK_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE5_DECAY_TUNE;
	param_group[j].param_list[k++] = -1;
	j++;
	k = 0;
	notebook_order[25] = j;
	one_page_order[25] = j;
	widescreen_order[25] = j;
	param_group[j].name = "voice6";
	param_group[j].label = "<b>Voice-6</b>";
	param_group[j].full_x  = 2;
	param_group[j].notebook_page = 2;
	param_group[j].notebook_x    = 1;
	param_group[j].wide_x        = 5;
	param_group[j].param_list[k++] = PARAM_VOICE6_MUTE;
	param_group[j].param_list[k++] = PARAM_VOICE6_PAN;
	param_group[j].param_list[k++] = PARAM_VOICE6_OSC_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE6_CUTOFF_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE6_ATTACK_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE6_DECAY_TUNE;
	param_group[j].param_list[k++] = -1;
	j++;
	k = 0;
	notebook_order[26] = j;
	one_page_order[26] = j;
	widescreen_order[26] = j;
	param_group[j].name = "voice7";
	param_group[j].label = "<b>Voice-7</b>";
	param_group[j].full_x  = 2;
	param_group[j].notebook_page = 2;
	param_group[j].notebook_x    = 2;
	param_group[j].wide_x        = 5;
	param_group[j].param_list[k++] = PARAM_VOICE7_MUTE;
	param_group[j].param_list[k++] = PARAM_VOICE7_PAN;
	param_group[j].param_list[k++] = PARAM_VOICE7_OSC_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE7_CUTOFF_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE7_ATTACK_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE7_DECAY_TUNE;
	param_group[j].param_list[k++] = -1;
	j++;
	k = 0;
	notebook_order[27] = j;
	one_page_order[27] = j;
	widescreen_order[27] = j;
	param_group[j].name = "voice8";
	param_group[j].label = "<b>Voice-8</b>";
	param_group[j].full_x  = 2;
	param_group[j].notebook_page = 2;
	param_group[j].notebook_x    = 3;
	param_group[j].wide_x        = 5;
	param_group[j].param_list[k++] = PARAM_VOICE8_MUTE;
	param_group[j].param_list[k++] = PARAM_VOICE8_PAN;
	param_group[j].param_list[k++] = PARAM_VOICE8_OSC_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE8_CUTOFF_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE8_ATTACK_TUNE;
	param_group[j].param_list[k++] = PARAM_VOICE8_DECAY_TUNE;
	param_group[j].param_list[k++] = -1;
}
