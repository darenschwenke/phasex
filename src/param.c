...
init_params(void)
{
	...
	init_param_info(PARAM_KEYMODE,               "keymode",             "KeyMode",     PARAM_TYPE_DTNT, -1,   6,   6,   0, 0,  1, 0, update_keymode,              keymode_labels,     keymode_names);
	...
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	init_param_info(PARAM_REVERB_MIX,            "reverb_mix",          "Mix",         PARAM_TYPE_REAL, -1, 127,  16,   0, 0,  8, 0, update_delay_mix,            NULL,               NULL);
	init_param_info(PARAM_REVERB_BYPASS,         "reverb_bypass",       "Bypass",      PARAM_TYPE_BOOL, -1, 127,   0,   0, 0,  1, 0, update_reverb_bypass,        on_off_labels,      boolean_names);
	init_param_info(PARAM_REVERB_MODE,           "reverb_mode",         "Mode",        PARAM_TYPE_BOOL, -1, 127,   0,   0, 0,  1, 0, update_reverb_mode,          reverb_mode_labels, reverb_mode_names);
	init_param_info(PARAM_REVERB_ROOMSIZE,       "reverb_roomsize",     "Room Size",   PARAM_TYPE_REAL, -1, 127,  16,   0, 0,  8, 0, update_reverb_roomsize,      NULL,               NULL);
	init_param_info(PARAM_REVERB_DAMPING,        "reverb_damping",      "Damping",     PARAM_TYPE_REAL, -1, 127,  16,   0, 0,  8, 0, update_reverb_damping,       NULL,               NULL);
	init_param_info(PARAM_REVERB_WIDTH,          "reverb_width",        "Width",       PARAM_TYPE_REAL, -1, 127,  16,   0, 0,  8, 0, update_reverb_width,         NULL,               NULL);
	init_param_info(PARAM_REVERB_DEPTH,          "reverb_depth",        "Depth",       PARAM_TYPE_REAL, -1, 127,  16,   0, 0,  8, 0, update_reverb_depth,         NULL,               NULL);
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	...
	init_param_info(PARAM_OSC1_PAN,              "osc1_pan",            "Pan",         PARAM_TYPE_REAL, -1, 127,  64, -64, 0,  8, 0, update_osc_pan,              NULL,               NULL);
	...
	init_param_info(PARAM_OSC1_PAN_LFO,          "osc1_pan_lfo",       "Pan Mod",      PARAM_TYPE_DTNT, -1,   9,   0,   0, 0,  1, 0, update_osc_pan_lfo,          mod_labels,         mod_names);
	init_param_info(PARAM_OSC1_PAN_LFO_AMOUNT,   "osc1_pan_lfo_amount","Pan Amt",      PARAM_TYPE_REAL, -1, 127,  64, -64, 0,  8, 0, update_osc_pan_lfo_amount,   NULL,               NULL);
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	...
	init_param_info(PARAM_OSC2_PAN,              "osc2_pan",            "Pan",         PARAM_TYPE_REAL, -1, 127,  64, -64, 1,  8, 0, update_osc_pan,              NULL,               NULL);
	...
	init_param_info(PARAM_OSC2_PAN_LFO,          "osc2_pan_lfo",        "Pan Mod",     PARAM_TYPE_DTNT, -1,   9,   0,   0, 1,  1, 0, update_osc_pan_lfo,          mod_labels,         mod_names);
	init_param_info(PARAM_OSC2_PAN_LFO_AMOUNT,   "osc2_pan_lfo_amount", "Pan Amt",     PARAM_TYPE_REAL, -1, 127,  64, -64, 1,  8, 0, update_osc_pan_lfo_amount,   NULL,               NULL);
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	...
	init_param_info(PARAM_OSC3_PAN,              "osc3_pan",            "Pan",         PARAM_TYPE_REAL, -1, 127,  64, -64, 2,  8, 0, update_osc_pan,              NULL,               NULL);
	...
	init_param_info(PARAM_OSC3_PAN_LFO,          "osc3_pan_lfo",        "Pan Mod",     PARAM_TYPE_DTNT, -1,   9,   0,   0, 2,  1, 0, update_osc_pan_lfo,          mod_labels,         mod_names);
	init_param_info(PARAM_OSC3_PAN_LFO_AMOUNT,   "osc3_pan_lfo_amount", "Pan Amt",     PARAM_TYPE_REAL, -1, 127,  64, -64, 2,  8, 0, update_osc_pan_lfo_amount,   NULL,               NULL);
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	...
	init_param_info(PARAM_OSC4_PAN,              "osc4_pan",            "Pan",         PARAM_TYPE_REAL, -1, 127,  64, -64, 3,  8, 0, update_osc_pan,              NULL,               NULL);
	...
	init_param_info(PARAM_OSC4_PAN_LFO,          "osc4_pan_lfo",        "Pan Mod",     PARAM_TYPE_DTNT, -1,   9,   0,   0, 3,  1, 0, update_osc_pan_lfo,          mod_labels,         mod_names);
	init_param_info(PARAM_OSC4_PAN_LFO_AMOUNT,   "osc4_pan_lfo_amount", "Pan Amt",     PARAM_TYPE_REAL, -1, 127,  64, -64, 3,  8, 0, update_osc_pan_lfo_amount,   NULL,               NULL);
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	init_param_info(PARAM_VOICE1_MUTE,           "voice1_mute",       	"Mute",        PARAM_TYPE_BOOL, -1,   1,   0,   0, 0,  1, 0, update_voice_mute,           on_off_labels,      boolean_names);
	init_param_info(PARAM_VOICE1_PAN,     		 "voice1_pan",          "Pan",         PARAM_TYPE_INT,  -1, 127,  64, -64, 0,  8, 0, update_voice_pan,            NULL,               NULL);
	init_param_info(PARAM_VOICE1_OSC_TUNE,       "voice1_osc_tune",     "Fine Tune",   PARAM_TYPE_INT,  -1, 127,  64, -64, 0,  8, 0, update_voice_osc_tune,       NULL,               NULL);
	init_param_info(PARAM_VOICE1_CUTOFF_TUNE,    "voice1_cutoff_tune",  "Cutoff Tune", PARAM_TYPE_INT,  -1, 127,  64, -64, 0,  8, 0, update_voice_cutoff_tune,    NULL,               NULL);
	init_param_info(PARAM_VOICE1_ATTACK_TUNE,    "voice1_env_att_tune", "Env Att Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 0,  8, 0, update_voice_env_attack_tune,NULL,               NULL);
	init_param_info(PARAM_VOICE1_DECAY_TUNE,     "voice1_env_dec_tune", "Env Dec Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 0,  8, 0, update_voice_env_decay_tune, NULL,               NULL);
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	init_param_info(PARAM_VOICE2_MUTE,           "voice2_mute",       	"Mute",        PARAM_TYPE_BOOL, -1,   1,   0,   0, 1,  1, 0, update_voice_mute,           on_off_labels,      boolean_names);
	init_param_info(PARAM_VOICE2_PAN,     		 "voice2_pan",          "Pan",         PARAM_TYPE_INT,  -1, 127,  64, -64, 1,  8, 0, update_voice_pan,            NULL,               NULL);
	init_param_info(PARAM_VOICE2_OSC_TUNE,       "voice2_osc_tune",     "Fine Tune",   PARAM_TYPE_INT,  -1, 127,  64, -64, 1,  8, 0, update_voice_osc_tune,       NULL,               NULL);
	init_param_info(PARAM_VOICE2_CUTOFF_TUNE,    "voice2_cutoff_tune",  "Cutoff Tune", PARAM_TYPE_INT,  -1, 127,  64, -64, 1,  8, 0, update_voice_cutoff_tune,    NULL,               NULL);
	init_param_info(PARAM_VOICE2_ATTACK_TUNE,    "voice2_env_att_tune", "Env Att Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 1,  8, 0, update_voice_env_attack_tune,NULL,               NULL);
	init_param_info(PARAM_VOICE2_DECAY_TUNE,     "voice2_env_dec_tune", "Env Dec Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 1,  8, 0, update_voice_env_decay_tune, NULL,               NULL);
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	init_param_info(PARAM_VOICE3_MUTE,           "voice3_mute",       	"Mute",        PARAM_TYPE_BOOL, -1,   1,   0,   0, 2,  1, 0, update_voice_mute,           on_off_labels,      boolean_names);
	init_param_info(PARAM_VOICE3_PAN,     		 "voice3_pan",          "Pan",         PARAM_TYPE_INT,  -1, 127,  64, -64, 2,  8, 0, update_voice_pan,            NULL,               NULL);
	init_param_info(PARAM_VOICE3_OSC_TUNE,       "voice3_osc_tune",     "Fine Tune",   PARAM_TYPE_INT,  -1, 127,  64, -64, 2,  8, 0, update_voice_osc_tune,       NULL,               NULL);
	init_param_info(PARAM_VOICE3_CUTOFF_TUNE,    "voice3_cutoff_tune",  "Cutoff Tune", PARAM_TYPE_INT,  -1, 127,  64, -64, 2,  8, 0, update_voice_cutoff_tune,    NULL,               NULL);
	init_param_info(PARAM_VOICE3_ATTACK_TUNE,    "voice3_env_att_tune", "Env Att Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 2,  8, 0, update_voice_env_attack_tune,NULL,               NULL);
	init_param_info(PARAM_VOICE3_DECAY_TUNE,     "voice3_env_dec_tune", "Env Dec Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 2,  8, 0, update_voice_env_decay_tune, NULL,               NULL);
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	init_param_info(PARAM_VOICE4_MUTE,           "voice4_mute",       	"Mute",        PARAM_TYPE_BOOL, -1,   1,   0,   0, 3,  1, 0, update_voice_mute,           on_off_labels,      boolean_names);
	init_param_info(PARAM_VOICE4_PAN,     		 "voice4_pan",          "Pan",         PARAM_TYPE_INT,  -1, 127,  64, -64, 3,  8, 0, update_voice_pan,            NULL,               NULL);
	init_param_info(PARAM_VOICE4_OSC_TUNE,       "voice4_osc_tune",     "Fine Tune",   PARAM_TYPE_INT,  -1, 127,  64, -64, 3,  8, 0, update_voice_osc_tune,       NULL,               NULL);
	init_param_info(PARAM_VOICE4_CUTOFF_TUNE,    "voice4_cutoff_tune",  "Cutoff Tune", PARAM_TYPE_INT,  -1, 127,  64, -64, 3,  8, 0, update_voice_cutoff_tune,    NULL,               NULL);
	init_param_info(PARAM_VOICE4_ATTACK_TUNE,    "voice4_env_att_tune", "Env Att Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 3,  8, 0, update_voice_env_attack_tune,NULL,               NULL);
	init_param_info(PARAM_VOICE4_DECAY_TUNE,     "voice4_env_dec_tune", "Env Dec Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 3,  8, 0, update_voice_env_decay_tune, NULL,               NULL);
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	init_param_info(PARAM_VOICE5_MUTE,           "voice5_mute",       	"Mute",        PARAM_TYPE_BOOL, -1,   1,   0,   0, 4,  1, 0, update_voice_mute,           on_off_labels,      boolean_names);
	init_param_info(PARAM_VOICE5_PAN,     		 "voice5_pan",          "Pan",         PARAM_TYPE_INT,  -1, 127,  64, -64, 4,  8, 0, update_voice_pan,            NULL,               NULL);
	init_param_info(PARAM_VOICE5_OSC_TUNE,       "voice5_osc_tune",     "Fine Tune",   PARAM_TYPE_INT,  -1, 127,  64, -64, 4,  8, 0, update_voice_osc_tune,       NULL,               NULL);
	init_param_info(PARAM_VOICE5_CUTOFF_TUNE,    "voice5_cutoff_tune",  "Cutoff Tune", PARAM_TYPE_INT,  -1, 127,  64, -64, 4,  8, 0, update_voice_cutoff_tune,    NULL,               NULL);
	init_param_info(PARAM_VOICE5_ATTACK_TUNE,    "voice5_env_att_tune", "Env Att Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 4,  8, 0, update_voice_env_attack_tune,NULL,               NULL);
	init_param_info(PARAM_VOICE5_DECAY_TUNE,     "voice5_env_dec_tune", "Env Dec Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 4,  8, 0, update_voice_env_decay_tune, NULL,               NULL);
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	init_param_info(PARAM_VOICE6_MUTE,           "voice6_mute",       	"Mute",        PARAM_TYPE_BOOL, -1,   1,   0,   0, 5,  1, 0, update_voice_mute,           on_off_labels,      boolean_names);
	init_param_info(PARAM_VOICE6_PAN,     		 "voice6_pan",          "Pan",         PARAM_TYPE_INT,  -1, 127,  64, -64, 5,  8, 0, update_voice_pan,            NULL,               NULL);
	init_param_info(PARAM_VOICE6_OSC_TUNE,       "voice6_osc_tune",     "Fine Tune",   PARAM_TYPE_INT,  -1, 127,  64, -64, 5,  8, 0, update_voice_osc_tune,       NULL,               NULL);
	init_param_info(PARAM_VOICE6_CUTOFF_TUNE,    "voice6_cutoff_tune",  "Cutoff Tune", PARAM_TYPE_INT,  -1, 127,  64, -64, 5,  8, 0, update_voice_cutoff_tune,    NULL,               NULL);
	init_param_info(PARAM_VOICE6_ATTACK_TUNE,    "voice6_env_att_tune", "Env Att Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 5,  8, 0, update_voice_env_attack_tune,NULL,               NULL);
	init_param_info(PARAM_VOICE6_DECAY_TUNE,     "voice6_env_dec_tune", "Env Dec Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 5,  8, 0, update_voice_env_decay_tune, NULL,               NULL);
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	init_param_info(PARAM_VOICE7_MUTE,           "voice7_mute",       	"Mute",        PARAM_TYPE_BOOL, -1,   1,   0,   0, 6,  1, 0, update_voice_mute,           on_off_labels,      boolean_names);
	init_param_info(PARAM_VOICE7_PAN,     		 "voice7_pan",          "Pan",         PARAM_TYPE_INT,  -1, 127,  64, -64, 6,  8, 0, update_voice_pan,            NULL,               NULL);
	init_param_info(PARAM_VOICE7_OSC_TUNE,       "voice7_osc_tune",     "Fine Tune",   PARAM_TYPE_INT,  -1, 127,  64, -64, 6,  8, 0, update_voice_osc_tune,       NULL,               NULL);
	init_param_info(PARAM_VOICE7_CUTOFF_TUNE,    "voice7_cutoff_tune",  "Cutoff Tune", PARAM_TYPE_INT,  -1, 127,  64, -64, 6,  8, 0, update_voice_cutoff_tune,    NULL,               NULL);
	init_param_info(PARAM_VOICE7_ATTACK_TUNE,    "voice7_env_att_tune", "Env Att Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 6,  8, 0, update_voice_env_attack_tune,NULL,               NULL);
	init_param_info(PARAM_VOICE7_DECAY_TUNE,     "voice7_env_dec_tune", "Env Dec Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 6,  8, 0, update_voice_env_decay_tune, NULL,               NULL);
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	init_param_info(PARAM_VOICE8_MUTE,           "voice8_mute",       	"Mute",        PARAM_TYPE_BOOL, -1,   1,   0,   0, 7,  1, 0, update_voice_mute,           on_off_labels,      boolean_names);
	init_param_info(PARAM_VOICE8_PAN,     		 "voice8_pan",          "Pan",         PARAM_TYPE_INT,  -1, 127,  64, -64, 7,  8, 0, update_voice_pan,            NULL,               NULL);
	init_param_info(PARAM_VOICE8_OSC_TUNE,       "voice8_osc_tune",     "Fine Tune",   PARAM_TYPE_INT,  -1, 127,  64, -64, 7,  8, 0, update_voice_osc_tune,       NULL,               NULL);
	init_param_info(PARAM_VOICE8_CUTOFF_TUNE,    "voice8_cutoff_tune",  "Cutoff Tune", PARAM_TYPE_INT,  -1, 127,  64, -64, 7,  8, 0, update_voice_cutoff_tune,    NULL,               NULL);
	init_param_info(PARAM_VOICE8_ATTACK_TUNE,    "voice8_env_att_tune", "Env Att Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 7,  8, 0, update_voice_env_attack_tune,NULL,               NULL);
	init_param_info(PARAM_VOICE8_DECAY_TUNE,     "voice8_env_dec_tune", "Env Dec Tune",PARAM_TYPE_INT,  -1, 127,  64, -64, 7,  8, 0, update_voice_env_decay_tune, NULL,               NULL);
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	...
	/*              index                         name                   label          type             cc  lim  ccv ofst ix leap    callback                    labels              names */
	init_param_info(PARAM_FILTER1_CUTOFF,        "filter1_cutoff",      "Cutoff",      PARAM_TYPE_REAL,  1, 127, 127,   0, 0, 12, 0, update_filter_cutoff,        NULL,               NULL);
	init_param_info(PARAM_FILTER1_RESONANCE,     "filter1_resonance",   "Resonance",   PARAM_TYPE_INT,  -1, 127,  32,   0, 0,  8, 0, update_filter_resonance,     NULL,               NULL);
	init_param_info(PARAM_FILTER1_SMOOTHING,     "filter1_smoothing",   "Smoothing",   PARAM_TYPE_INT,  -1, 127,   0,   0, 0,  8, 0, update_filter_smoothing,     NULL,               NULL);
	init_param_info(PARAM_FILTER1_KEYFOLLOW,     "filter1_keyfollow",   "KeyFollow",   PARAM_TYPE_DTNT, -1,   4,   0,   0, 0,  1, 0, update_filter_keyfollow,     keyfollow_labels,   keyfollow_names);
	init_param_info(PARAM_FILTER1_MODE,          "filter1_mode",        "Mode",        PARAM_TYPE_DTNT, -1,   7,   0,   0, 0,  1, 0, update_filter_mode,          filter_mode_labels, filter_mode_names);
	init_param_info(PARAM_FILTER1_TYPE,          "filter1_type",        "Type",        PARAM_TYPE_DTNT, -1,   5,   0,   0, 0,  1, 0, update_filter_type,          filter_type_labels, filter_type_names);
	init_param_info(PARAM_FILTER1_GAIN,          "filter1_gain",        "Filter Gain", PARAM_TYPE_REAL, -1, 127,  64,   0, 0,  8, 0, update_filter_gain,          NULL,               NULL);
	init_param_info(PARAM_FILTER1_ENV_AMOUNT,    "filter1_env_amount",  "Env Amt",     PARAM_TYPE_REAL, -1, 127,  12,   0, 0, 12, 0, update_filter_env_amount,    NULL,               NULL);
	init_param_info(PARAM_FILTER1_ENV_SIGN,      "filter1_env_sign",    "Env Sign",    PARAM_TYPE_BOOL, -1,   1,   1,   0, 0,  1, 0, update_filter_env_sign,      sign_labels,        sign_names);
	init_param_info(PARAM_FILTER1_LFO,           "filter1_lfo",         "LFO",         PARAM_TYPE_BBOX, -1,   4,   0,   0, 0,  1, 0, update_filter_lfo,           velo_lfo_labels,    velo_lfo_names);
	init_param_info(PARAM_FILTER1_LFO_CUTOFF,    "filter1_lfo_cutoff",  "LFO Cutoff",  PARAM_TYPE_REAL, -1, 127,  64, -64, 0, 12, 0, update_filter_lfo_cutoff,    NULL,               NULL);
	init_param_info(PARAM_FILTER1_LFO_RESONANCE, "filter1_lfo_resonance","LFO Res",    PARAM_TYPE_REAL, -1, 127,  64, -64, 0,  8, 0, update_filter_lfo_resonance, NULL,               NULL);
	init_param_info(PARAM_FILTER1_ATTACK,        "filter1_attack",      "Attack",      PARAM_TYPE_INT,  -1, 127,   0,   0, 0,  8, 0, update_filter_attack,        NULL,               NULL);
	init_param_info(PARAM_FILTER1_DECAY,         "filter1_decay",       "Decay",       PARAM_TYPE_INT,  -1, 127,  48,   0, 0,  8, 0, update_filter_decay,         NULL,               NULL);
	init_param_info(PARAM_FILTER1_SUSTAIN,       "filter1_sustain",     "Sustain",     PARAM_TYPE_REAL, -1, 127,   0,   0, 0,  8, 0, update_filter_sustain,       NULL,               NULL);
	init_param_info(PARAM_FILTER1_RELEASE,       "filter1_release",     "Release",     PARAM_TYPE_INT,  -1, 127,  32,   0, 0,  8, 0, update_filter_release,       NULL,               NULL);
