...
void update_reverb_mix(PARAM *param);
void update_reverb_bypass(PARAM *param);
void update_reverb_mode(PARAM *param);
void update_reverb_damping(PARAM *param);
void update_reverb_roomsize(PARAM *param);
void update_reverb_width(PARAM *param);
void update_reverb_depth(PARAM *param);
...
void update_osc_pan(PARAM *param);
...
void update_osc_pan_lfo(PARAM *param);
void update_osc_pan_lfo_amount(PARAM *param);
...
void update_voice_active(PARAM *param);
void update_voice_mute(PARAM *param);
void update_voice_pan(PARAM *param);
void update_voice_osc_tune(PARAM *param);
void update_voice_cutoff_tune(PARAM *param);
void update_voice_env_attack_tune(PARAM *param);
void update_voice_env_decay_tune(PARAM *param);
